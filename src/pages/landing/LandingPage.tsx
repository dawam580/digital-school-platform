      ...
      <header className="sticky top-0 z-50 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 sm:h-20 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button
              type="button"
              onClick={() => { sound.playTap(); setActiveTab('parent-mobile'); }}
              className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-black bg-emerald-50 dark:bg-emerald-950/50 hover:bg-emerald-100 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800 transition active:scale-95"
            >
          ...
          <div className="text-center max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-center justify-center gap-3 sm:gap-4 flex-wrap pt-3">
              ...
              <button
                type="button"
                onClick={() => { sound.playTap(); setActiveTab('parent-mobile'); }}
                className="px-6 sm:px-8 py-3.5 sm:py-4 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white text-sm sm:text-base font-black shadow-lg shadow-emerald-600/25 transition active:scale-95 flex items-center gap-2"
              >
                <Smartphone className="w-5 h-5 text-emerald-200" />
                <span>📱 تجربة تطبيق ولي الأمر (الهاتف)</span>
              </button>
